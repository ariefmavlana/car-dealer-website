...
const inputClassNames = {
	...
	size: "p-2 text-2xl text-gray-600 font-medium w-12 h-12 sm:h-[70px] sm: w-[70px]",
	color: {
		base: "bg-transparent focus:ring-[0.6px] border border-gray-300 focus-visible:border-secondary focus-visible:outline-hidden focus-visible:ring-1 focus-visible:ring-secondary placeholder:text-slate-950 text-gray-600",
		active: "not-read-only:hover:enabled:border-secondary focus:ring-secondary text-gray-600",
	},
}
