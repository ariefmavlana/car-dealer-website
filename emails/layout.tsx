import { Body, Column, Container, Font, Head, Html, Img, Link, Preview, Row, Section, Tailwind } from "@react-email/components"
								...
								<Row>
									...
									<Column align="right">
										<address className="not-italic text-right text-xs">
											<span className="text-gray-800">Mavlana Motors</span>
											<br />Jl. Ahmad Yani, No. 1, <br />
											Bandung, Indonesia <br />
											<Link
												className="text-blue-600 underline"
												href={"mailto:hello@ariefmaulana.tech"}
											>
												hello@ariefmaulana.tech
											</Link>
										</address>
									</Column>
								</Row>
