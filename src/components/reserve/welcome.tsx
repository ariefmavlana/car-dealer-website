...
import { type MultiStepFormComponentProps, MultiStepFormEnum, } from "@/config/types";
			...
			<div className="p-6">
				<div className="flex gap-x-12 justify-between">
					...
					<div className="flex flex-1 space-x-2">
						...
						<div className="flex-1">
							<h2 className="text-gray-500 text-lg font-semibold line-clamp-1">
				...
				<div className="flex justify-around items-center bg-gray-100 p-4 rounded-md mb-4">
					<div className="text-center">
						<p className="text-gray-500 font-bold">Select Handover Date & Time</p>
						<p className="text-gray-500">approx. 1 minute</p>
					</div>
					<ArrowRightIcon className="w-6 h-6" />
					<div className="text-center">
						<p className="text-gray-500 font-bold">Submit Your Details</p>
						<p className="text-gray-500">approx. 1 minute</p>
					</div>
				</div>
				<p className="text-gray-500 font-bold mb-4">Ready to begin?</p>
