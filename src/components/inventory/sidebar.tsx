...
export const Sidebar = ({ minMaxValues, searchParams }: SidebarProps) => {
  ...
  return (
    <div className="py-4 w-[21.5rem] bg-white border-r border-muted hidden lg:block">
      <div>
        <div className="text-gray-900 text-lg font-semibold flex justify-between px-4">
          <span>Filters</span>
          <button
          type="button"
      ...
      <div className="p-4">
        <SearchInput 
          ...
          className="text-gray-800 w-full px-3 py-2 border rounded-md focus:outline-hidden focus:ring-2 focus:ring-blue-500"/>
      </div>
      <div className="text-gray-800 p-4 space-y-2">
        <TaxonomyFilters
