...
export const DialogFilters = (props: DialogFiltersProps) => {
	...
	return (
		<Dialog open={open} onOpenChange={setIsOpen}>
			...
			<DialogContent className="text-gray-900 max-w-[425px] h-[90vh] overflow-y-auto rounded-xl bg-white">
				<div className="space-y-6">
					<div>
						<div className="text-gray-900 text-lg font-semibold flex justify-between">
