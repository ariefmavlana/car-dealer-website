...
export const FavouriteButton = (props: FavouriteButtonProps) => {
  ...
  return ( 
    <Button onClick={handleFavourite} variant="ghost" size="icon" className={cn(
      ...
      <HeartIcon className={cn(
        "duration-200 transition-colors ease-in-out w-3.5 h-3.5 lg:w-4 lg:h-4 xl:h-6 xl:w-6 text-white",
